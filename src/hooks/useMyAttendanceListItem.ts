...
export const useMyAttendanceListItem = () => {
  ...
  const getMyAttendanceListItem = useCallback(async () => {
  ...
  }, [history, showMessage, attendancesConverter]);
  return { getMyAttendanceListItem, myAttendances, setMyAttendances };
};
